...
This one has less dot crawl and rainbow artifacts than the Tributaries, Kramer and Extron, but more than the Radioshack filter. It exhibits a fair bit of dot crawl on NES games in particular. It does do a slightly better job with the diagonal lines on NES and SNES and Genesis Jailbars.
